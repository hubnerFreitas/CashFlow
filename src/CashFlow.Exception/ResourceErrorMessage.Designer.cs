...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessage {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Expenses cannot be from future.
        /// </summary>
        public static string EXPENSES_CANNOT_BE_FROM_FUTURE {
            get {
                return ResourceManager.GetString("EXPENSES_CANNOT_BE_FROM_FUTURE", resourceCulture);
            }
        }
